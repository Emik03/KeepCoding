...
namespace KeepCoding.v14
{
    ...
    public static class Game
    {
        ...
        public static class ModManager
        {
            ...
            /// </value>
            public static Func<List<string>> GetDisabledModPaths => global::ModManager.Instance.GetDisabledModPaths;

            /// <value>
            /// Gets all of the enabled mod paths within the <see cref="ModSourceEnum"/> constraint.
            /// </value>
            public static Func<ModSourceEnum, List<string>> GetEnabledModPaths => m => global::ModManager.Instance.GetEnabledModPaths((Info.ModSourceEnum)m);
        }
