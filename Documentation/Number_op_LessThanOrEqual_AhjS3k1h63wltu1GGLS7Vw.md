...
```
#### Parameters
<a name='KeepCoding_Number_op_LessThanOrEqual(KeepCoding_Number_KeepCoding_Number)_number'></a>
`number` [Number](Number.md 'KeepCoding.Number')  
The left-hand side of the operator.
  
<a name='KeepCoding_Number_op_LessThanOrEqual(KeepCoding_Number_KeepCoding_Number)_other'></a>
