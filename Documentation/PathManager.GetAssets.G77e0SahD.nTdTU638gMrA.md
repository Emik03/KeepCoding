...
```
#### Type parameters
<a name='KeepCoding.PathManager.GetAssets.TAsset.(System.Type.string).TAsset'></a>
`TAsset`  
  
#### Parameters
<a name='KeepCoding.PathManager.GetAssets.TAsset.(System.Type.string).type'></a>
`type` [System.Type](https://docs.microsoft.com/en-us/dotnet/api/System.Type 'System.Type')  
Any data from the assembly, which is used to get the name.
  
<a name='KeepCoding.PathManager.GetAssets.TAsset.(System.Type.string).bundleVideoFileName'></a>
...
#### Returns
[TAsset](PathManager.GetAssets.G77e0SahD.nTdTU638gMrA.md#KeepCoding.PathManager.GetAssets.TAsset.(System.Type.string).TAsset 'KeepCoding.PathManager.GetAssets&lt;TAsset&gt;(System.Type, string).TAsset')[[]](https://docs.microsoft.com/en-us/dotnet/api/System.Array 'System.Array')  
