...
A new instance of [vector](TypeHelper_Add_XTLlzU0nnwOVgeCC_GFJfw.md#KeepCoding_TypeHelper_Add(Vector3_float_float_float)_vector 'KeepCoding.TypeHelper.Add(Vector3, float, float, float).vector'), with the arguments replacing the values.
