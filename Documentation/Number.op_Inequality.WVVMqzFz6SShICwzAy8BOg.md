...
```
#### Parameters
<a name='KeepCoding.Number.op_Inequality(KeepCoding.Number.System.ValueType).number'></a>
`number` [Number](Number.md 'KeepCoding.Number')  
The left-hand side of the operator.
  
<a name='KeepCoding.Number.op_Inequality(KeepCoding.Number.System.ValueType).other'></a>
