...
The action to do on each item in [iterator](KeyHelper_ForEach_uQUoBBwx27+rmaPykPmPqQ.md#KeepCoding_KeyHelper_ForEach(System_Collections_IEnumerable_System_Action_object_)_iterator 'KeepCoding.KeyHelper.ForEach(System.Collections.IEnumerable, System.Action&lt;object&gt;).iterator').
...
[iterator](KeyHelper_ForEach_uQUoBBwx27+rmaPykPmPqQ.md#KeepCoding_KeyHelper_ForEach(System_Collections_IEnumerable_System_Action_object_)_iterator 'KeepCoding.KeyHelper.ForEach(System.Collections.IEnumerable, System.Action&lt;object&gt;).iterator')
#### Exceptions
