...
```csharp
public KeepCoding.Sound[] PlaySound(UnityEngine.Transform transform, bool loop, params KeepCoding.Sound[] sounds);
```
#### Parameters
<a name='KeepCoding_ModuleScript_PlaySound(UnityEngine_Transform_bool_KeepCoding_Sound__)_transform'></a>
...
<a name='KeepCoding_ModuleScript_PlaySound(UnityEngine_Transform_bool_KeepCoding_Sound__)_loop'></a>
...
<a name='KeepCoding_ModuleScript_PlaySound(UnityEngine_Transform_bool_KeepCoding_Sound__)_sounds'></a>
