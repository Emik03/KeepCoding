...
## Number.Parse(string, IFormatProvider) Method
...
```csharp
public static KeepCoding.Number Parse(string s, System.IFormatProvider provider);
```
#### Parameters
<a name='KeepCoding_Number_Parse(string_System_IFormatProvider)_s'></a>
`s` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String') to parse.
  
<a name='KeepCoding_Number_Parse(string_System_IFormatProvider)_provider'></a>
