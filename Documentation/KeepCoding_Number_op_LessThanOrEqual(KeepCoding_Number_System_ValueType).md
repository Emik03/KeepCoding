...
```
#### Parameters
<a name='KeepCoding_Number_op_LessThanOrEqual(KeepCoding_Number_System_ValueType)_number'></a>
`number` [Number](KeepCoding_Number.md 'KeepCoding.Number')  
The left-hand side of the operator.
  
<a name='KeepCoding_Number_op_LessThanOrEqual(KeepCoding_Number_System_ValueType)_other'></a>
