...
```
#### Parameters
<a name='KeepCoding.BigInteger.op_Subtraction(KeepCoding.BigInteger.object).bigInteger'></a>
`bigInteger` [BigInteger](BigInteger.md 'KeepCoding.BigInteger')  
The left-hand side operator.
  
<a name='KeepCoding.BigInteger.op_Subtraction(KeepCoding.BigInteger.object).value'></a>
