...
```
#### Parameters
<a name='KeepCoding.BigInt.op_BitwiseAnd(KeepCoding.BigInt.KeepCoding.BigInt).one'></a>
`one` [BigInt](BigInt.md 'KeepCoding.BigInt')  
  
<a name='KeepCoding.BigInt.op_BitwiseAnd(KeepCoding.BigInt.KeepCoding.BigInt).two'></a>
