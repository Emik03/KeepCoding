...
## ModuleScript.PlaySound(Sound[]) Method
...
```csharp
public KeepCoding.Sound[] PlaySound(params KeepCoding.Sound[] sounds);
```
#### Parameters
<a name='KeepCoding_ModuleScript_PlaySound(KeepCoding_Sound__)_sounds'></a>
