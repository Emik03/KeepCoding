...
A new instance of the [color](TypeHelper_Add_TM0V2_i603FiH0EJj6MjiQ.md#KeepCoding_TypeHelper_Add(Color_byte_byte_byte_byte)_color 'KeepCoding.TypeHelper.Add(Color, byte, byte, byte, byte).color'), with the arguments replacing the values.
### Remarks
