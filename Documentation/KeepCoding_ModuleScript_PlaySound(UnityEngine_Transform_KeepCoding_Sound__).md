...
```csharp
public KeepCoding.Sound[] PlaySound(UnityEngine.Transform transform, params KeepCoding.Sound[] sounds);
```
#### Parameters
<a name='KeepCoding_ModuleScript_PlaySound(UnityEngine_Transform_KeepCoding_Sound__)_transform'></a>
...
<a name='KeepCoding_ModuleScript_PlaySound(UnityEngine_Transform_KeepCoding_Sound__)_sounds'></a>
