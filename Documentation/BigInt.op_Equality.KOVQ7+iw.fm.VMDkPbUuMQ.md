...
```
#### Parameters
<a name='KeepCoding.BigInt.op_Equality(KeepCoding.BigInt.KeepCoding.BigInt).one'></a>
`one` [BigInt](BigInt.md 'KeepCoding.BigInt')  
  
<a name='KeepCoding.BigInt.op_Equality(KeepCoding.BigInt.KeepCoding.BigInt).two'></a>
