...
namespace KeepCoding
{
    ...
    public class CacheableBehaviour : MonoBehaviour
    {
        ...
        /// <param name="allowNull">Whether it should throw an exception if it sees <see langword="null"/>, if not it will return the default value. (Likely <see langword="null"/>)</param>
        /// <returns>The component specified by <typeparamref name="T"/>.</returns>
        public T Get<T>(bool allowNull = false) where T : Component => Gets<T>(allowNull).FirstOrDefault();
        ...
        /// <param name="allowNull">Whether it should throw an exception if it sees <see langword="null"/>, if not it will return the default value. (Likely <see langword="null"/>)</param>
        /// <returns>The component specified by <typeparamref name="T"/>.</returns>
        public T GetChild<T>(bool includeInactive = false, bool allowNull = false) where T : Component => GetChildren<T>(includeInactive, allowNull).FirstOrDefault();
        ...
        /// <param name="allowNull">Whether it should throw an exception if it sees <see langword="null"/>, if not it will return the default value. (Likely <see langword="null"/>)</param>
        /// <returns>The component specified by <typeparamref name="T"/>.</returns>
        public T GetParent<T>(bool includeInactive = false, bool allowNull = false) where T : Component => GetParents<T>(includeInactive, allowNull).FirstOrDefault();
