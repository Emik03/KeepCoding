...
#pragma warning restore IDE1006 // Naming Styles
        ...
        protected IEnumerator ProcessTwitchCommand(string command) => command.ToLowerInvariant().Trim() is "colorblind" && Module.IsColorblindSupported ? ToggleColorblind() : Process(command);
