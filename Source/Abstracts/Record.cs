...
namespace KeepCoding
{
    ...
    /// <typeparam name="T">The type of data to encapsulate.</typeparam>
    /// <typeparam name="TThis">The type that is encapsulating <typeparamref name="T"/>.</typeparam>
    public abstract class StrictRecord<T, TThis> where TThis : StrictRecord<T, TThis>, new()
    {
        /// <summary>
        /// The value to store.
        /// </summary>
        ...
        /// <param name="a">The left-hand side record to compare.</param>
        /// <param name="b">The right-hand side record to compare.</param>
        /// <returns><see langword="true"/> if <paramref name="a"/> and <paramref name="b"/> are both <see langword="null"/>, or <see cref="Equals(StrictRecord{T, TThis})"/> returns <see langword="true"/>. Otherwise, <see langword="false"/>.</returns>
        public static bool operator ==(StrictRecord<T, TThis> a, StrictRecord<T, TThis> b) => a is null && b is null || !(a is null) && !(b is null) && a.Equals(b);
        ...
        /// <param name="a">The left-hand side record to compare.</param>
        /// <param name="b">The right-hand side record to compare.</param>
        /// <returns><see langword="false"/> if <paramref name="a"/> and <paramref name="b"/> are both <see langword="null"/>, or <see cref="Equals(StrictRecord{T, TThis})"/> returns <see langword="true"/>. Otherwise, <see langword="true"/>.</returns>
        ...
        /// </summary>
        /// <param name="obj">The other instance to compare.</param>
        /// <returns><see langword="false"/> if itself and <paramref name="obj"/> are both <see langword="null"/>, or <see cref="Equals(StrictRecord{T, TThis})"/> returns <see langword="true"/>. Otherwise, <see langword="true"/>.</returns>
        public override bool Equals(object obj) => !(obj is null) && (ReferenceEquals(this, obj) || obj.GetType() == GetType() && Equals((StrictRecord<T, TThis>)obj));
        ...
        /// </summary>
        /// <param name="other">The other instance to compare.</param>
        /// <returns><see langword="false"/> if itself and <paramref name="other"/> are both <see langword="null"/>, or <see cref="Equals(StrictRecord{T, TThis})"/> returns <see langword="true"/>. Otherwise, <see langword="true"/>.</returns>
