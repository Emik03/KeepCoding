...
namespace KeepCoding
{
    ...
    public static class TypeHelper
    {
        ...
        public static Color Add(this Color color, byte r = 0, byte g = 0, byte b = 0, byte a = 0)
            => new Color(
                (float)r / MaxValue + color.r,
                (float)g / MaxValue + color.g,
                (float)b / MaxValue + color.b,
                (float)a / MaxValue + color.a);
        ...
        public static Color Set(this Color color, byte? r = null, byte? g = null, byte? b = null, byte? a = null)
            => new Color(
                r.HasValue ? (float)r.Value / MaxValue : color.r,
                g.HasValue ? (float)g.Value / MaxValue : color.g,
                b.HasValue ? (float)b.Value / MaxValue : color.b,
                a.HasValue ? (float)a.Value / MaxValue : color.a);
        ...
        public static Color32 Add(this Color32 color, float r = 0, float g = 0, float b = 0, float a = 0)
            => new Color32(
                (byte)(r * MaxValue + color.r),
                (byte)(g * MaxValue + color.g),
                (byte)(b * MaxValue + color.b),
                (byte)(a * MaxValue + color.a));
        ...
        public static Color32 HexToColor(this string hex)
        {
            ...
            return !(hex.Length is 6 || hex.Length is 8)
        ...
        /// <returns>A new <see cref="Work"/> consisting of the arguments provided.</returns>
        public static Work ToWork(this int maximumThreadsActive, Action action, bool allowSimultaneousActive = false) => new Work(action, allowSimultaneousActive, maximumThreadsActive);
        ...
        public static Work<T> ToWork<T>(this int maximumThreadsActive, Func<T> func, bool allowSimultaneousActive = false) => new Work<T>(func, allowSimultaneousActive, maximumThreadsActive);
        ...
        public static Work<T, TResult> ToWork<T, TResult>(this int maximumThreadsActive, Func<T, TResult> func, bool allowSimultaneousActive = false) => new Work<T, TResult>(func, allowSimultaneousActive, maximumThreadsActive);
        ...
        public static Work<T1, T2, TResult> ToWork<T1, T2, TResult>(this int maximumThreadsActive, Func<T1, T2, TResult> func, bool allowSimultaneousActive = false) => new Work<T1, T2, TResult>(func, allowSimultaneousActive, maximumThreadsActive);
        ...
        public static Work<T1, T2, T3, TResult> ToWork<T1, T2, T3, TResult>(this int maximumThreadsActive, Func<T1, T2, T3, TResult> func, bool allowSimultaneousActive = false) => new Work<T1, T2, T3, TResult>(func, allowSimultaneousActive, maximumThreadsActive);
